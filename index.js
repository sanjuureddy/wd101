...
const displayEntries = () => {
  ...
  const tableRows = entries
    .map((entry) => {
      const cells = Object.values(entry).map(
        (value) => `<td class='border border-green-700 px-6 py-3'>${value}</td>`
      );
  ...
  const table = `<table class="table-auto w-full">
    <tr>
      <th class="px-6 py-3"; style="font-family:Verdana, sans-serif">Name</th>
      <th class="px-6 py-3" ; style="font-family:Verdana, sans-serif">Email</th>
      <th class="px-6 py-3" ; style="font-family:Verdana, sans-serif">Password</th>
      <th class="px-6 py-3"; style="font-family:Verdana, sans-serif">Dob</th>
      <th class="px-6 py-3" ; style="font-family:Verdana, sans-serif">Accepted terms?</th>
    </tr>${tableRows}</table>`;
